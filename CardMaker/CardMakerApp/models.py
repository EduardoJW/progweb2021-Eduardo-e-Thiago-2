...
class Carta(models.Model):
    ...
    tipo = models.CharField(max_length=100, choices = TIPO, help_text='Digite o tipo da carta')
    classe = models.CharField(max_length=100, choices = CLASSE, help_text='Digite a classe da carta')
